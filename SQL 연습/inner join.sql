-- inner join
-- 예제) 현재, 근무하고 있는 직원의 이름과 직책을 모두 출력 하세요.
select a.first_name, b.title
from employees a, titles b
where a.emp_no = b.emp_no
and b.to_date='9999-01-01';

-- 예제2) 현재, 지원의 이름과 직책을 출력하되 여성 엔지니어(engineer)만 출력하세요
select a.first_name, b.title
from employees a, titles b
where a.emp_no = b.emp_no
and b.to_date='9999-01-01'
...
-- 1) Natural Join
-- 두 테이블에 이름이 같은 공통 컬럼이 있으면 
-- 조인 조건을 명시하지 않아도 암묵적으로 조인 됨
select a.first_name, b.title
...
-- 실습문제 1:  현재 회사 생활을 반영한 직원별 근무부서를 
-- 사번, 직원 전체이름, 근무부서 형태로 출력해 보세요.
  select a.emp_no, concat(a.first_name," ",a.last_name) as 'full name', b.dept_name
...
select a.emp_no,concat(a.first_name," ",a.last_name) as 'full name',b.salary
